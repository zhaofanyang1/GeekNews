...
public class QianduanAdapter extends XRecyclerView.Adapter<QianduanAdapter.ViewHolder> {
    private List<QianDuanBean.ResultsBean> list;
    private Context context;

    public QianduanAdapter(List<QianDuanBean.ResultsBean> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        QianDuanBean.ResultsBean resultsBean = list.get(position);
